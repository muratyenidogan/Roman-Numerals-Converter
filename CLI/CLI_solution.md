...
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name murat2024 --security-groups roman_numbers_sec_grp1 --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data C:\Users\murat\Desktop\AWS-Portfolio\Roman-Numerals-Converter\CLI\userdata.sh
...
aws ec2 run-instances \
    ...
    --user-data C:\Users\murat\Desktop\AWS-Portfolio\Roman-Numerals-Converter\CLI\userdata.sh
```
